            ...
            <div className="about-me__content">
                <div className="about-me__about">
                    ...
                    <p className="about-me__description two-columns__main-text">
                        ...
                        и дочь. Я люблю музыку, фильмы, занимаюсь бегом и плаванием. Недавно освоил веб-разработку. С 2010 года работал в консалтинге в области управления проектами, знаю международные стандарты, имею опыт руководства. После того, как прошёл курс по веб-разработке, стал открыт к фриланс-заказам.
                    </p>
                    <div className="links">
